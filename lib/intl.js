...
addStrings('en', {
  ...
  "playerMatchStats.legend": "tr: tries, ta: try assists, pts: points, k: kicks, p: passes, r: runs, mr: Meters run, " +
    "cb: Clean breaks, db: Defenders beaten, ol: Offloads, to: Turnovers, tm: Tackles made, tmi: Tackles missed, lw: Lineouts won on throw, "+
