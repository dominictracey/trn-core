            ...
            return(
              <div className="FnR-match" key={match.id}>
                ...
                <div className="FnR-match-date">
                  <div className="FnR-matchData FnR-match-time"><FormattedDate value={dateTime}/></div>
                  <div className="FnR-matchData FnR-match-time"><FormattedTime value={dateTime}/></div>
                </div>
