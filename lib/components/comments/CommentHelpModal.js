      ...
      <div className="commentHelp-close" onClick={props.closeModal}><Components.Icon name="times" /></div>
        ...
        <div className="commentHelp-card">
          ...
          <div className="sidebar-card-body">
            ...
            <div className="commentHelp-item"><span className="commentHelp-result">Unordered List</span><span className="commentHelp-command">*item</span></div>
            <div className="commentHelp-item"><span className="commentHelp-result">Ordered List</span><span className="commentHelp-command">1. Item</span></div>
